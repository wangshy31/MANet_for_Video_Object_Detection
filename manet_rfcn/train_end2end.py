...
def train_net(args, ctx, pretrained, pretrained_flow, epoch, prefix, begin_epoch, end_epoch, lr, lr_step):
    ...
    max_data_shape.append(('delta_bef_gt', (config.TRAIN.BATCH_IMAGES, 100, 4)))
    max_data_shape.append(('delta_aft_gt', (config.TRAIN.BATCH_IMAGES, 100, 4)))
    max_data_shape.append(('occluded', (config.TRAIN.BATCH_IMAGES, 100, 1)))
    ...
    if config.TRAIN.RESUME:
        ...
        print config.TRAIN.USE_OCCLUSION
    ...
    delta_metric = metric.DELTAL1LossMetric(config)
